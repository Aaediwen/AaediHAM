...
MUF Module: E-Skip      europe_4m       Band Closed
                         ...
                         */
                         ...
                         xml_content = reinterpret_cast<const char*>(xmlNodeGetContent(current_node));
...
//                         *(host_api->AaediHAM_LogDebug) << band << "\t" << time << "\t" << condition << "\n";
                         ...
                         free(attribute);
                         attribute = nullptr;
                         VHF_Conditions[location] = reinterpret_cast<const char*>(xmlNodeGetContent(current_node));
               }
          }
     }
}
